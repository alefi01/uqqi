...
Generate a new design-project skeleton from `design-kit-starter/product-design/` (Track B
...
2. Copy every file of `design-kit-starter/product-design/` into it, preserving the tree.
